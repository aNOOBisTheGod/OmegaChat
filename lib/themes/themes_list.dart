...
ThemeData forestTheme = ThemeData(
    ...
    scaffoldBackgroundColor: Color(0xFF22577a),
    cardColor: Color(0xFF80ed99),
    appBarTheme: AppBarTheme(backgroundColor: Color(0xFF38a3a5)),
    drawerTheme: DrawerThemeData(backgroundColor: Color(0xFF57cc99)));
